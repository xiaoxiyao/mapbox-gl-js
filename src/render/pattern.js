...
exports._prepare = function (image: CrossFaded<string>, painter: Painter, program: Program): any /* TODO */ {
    const context = painter.context;
    const gl = context.gl;
...
exports._setTile = function (tile: {tileID: OverscaledTileID, tileSize: number}, painter: Painter, program: Program): any {
    const numTiles = Math.pow(2, tile.tileID.overscaledZ);
    const tileSizeAtNearestZoom = tile.tileSize * Math.pow(2, painter.transform.tileZoom) / numTiles;
